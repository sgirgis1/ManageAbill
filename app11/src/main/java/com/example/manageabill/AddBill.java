...
public class AddBill extends AppCompatActivity implements View.OnClickListener {
    ...
    private void processInsert(String name, String rem, String remTime) {
        //String result = new DBHelper(this).addReminder(name, rem, remTime);                  //inserts the title,date,time into sql lite database
        setAlarm(name, rem, remTime);                                                                //calls the set alarm method to set alarm
        //mTitledit.setText("");
